      ...
      <Container>
        ...
        <div className="flex flex-wrap gap-x-6 gap-y-1.5 pt-6 text-[0.8125rem] text-[#8AA4C6]">
          {businessInfo.representative && (
            <span>
              <T k="footer.biz.representative" /> <T k="biz.representative" />
            </span>
          )}
          {businessInfo.registrationNumber && (
            <span data-numeric>
              <T k="footer.biz.registration" /> <T k="biz.registration" />
            </span>
          )}
          {businessInfo.mailOrderNumber && (
            <span data-numeric>
              <T k="footer.biz.mailOrder" /> <T k="biz.mailOrder" />
            </span>
          )}
          {businessInfo.fax && (
            <span data-numeric>
              <T k="footer.biz.fax" /> <T k="biz.fax" />
            </span>
          )}
        </div>
