 ...
 *
 *    그래서 화면에도 「예시 초안」임을 반드시 함께 표기한다(PriceTable 컴포넌트가 표시).
...
export const priceGroups: PriceGroup[] = [
  ...
  },
  {
    label: "수건류",
    items: [
      { name: "대형 수건 (바스 타월)", price: 600 },
      { name: "중형 수건 (핸드 타월)", price: 400 },
...
export const priceOptions: { name: string; extra: string; note: string }[] = [
  ...
  { name: "급행 (당일 · 익일)", extra: "+20%", note: "일정 우선 세탁" },
...
export const priceTerms: { label: string; value: string; note?: string }[] = [
  {
    label: "최소 발주 금액",
    value: "30,000원",
    note: "미만은 수거 · 배달(납품)비 부과 또는 접수 제한",
  },
  {
    label: "수거 · 배달(납품)비",
    value: "정기 거래처 무료",
